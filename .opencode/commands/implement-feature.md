...
2. If the feature worktree does not exist, run `wt switch --create --yes --format json feat/<feature-name> --base <default-branch>` unless the reviewed feature spec explicitly established a different base branch.
