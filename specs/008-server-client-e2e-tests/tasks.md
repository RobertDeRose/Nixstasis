...
description: "Task list for server-client end-to-end tests"
---
...
- Feature docs: `specs/008-server-client-e2e-tests/...`
...
- [X] T001 Create E2E harness directories and placeholders in packages/client/scripts/e2e/README.md and packages/server/test/e2e/.gitkeep
...
- [X] T038 [P] Update quickstart with final runner flags in specs/008-server-client-e2e-tests/quickstart.md
