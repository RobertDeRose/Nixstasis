...
- **FR-012**: The system MUST support report-result filtering with wire operators `gt`, `gte`, `eq`, `lte`, and `lt` for numeric comparisons, plus `contains`, `not_contains`, `is`, and `is_not` for string comparisons.
