...
- [X] T044 [P] Update CLI contracts with `test_script` and `repl` in specs/007-starlark-script-system/contracts/cli.md
- [X] T045 Update quickstart with `test_script` and `repl` usage in specs/007-starlark-script-system/quickstart.md
- [X] T046 Run quickstart validation against updated CLI in specs/007-starlark-script-system/quickstart.md
