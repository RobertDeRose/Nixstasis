defmodule Nixstasis.Scripts.ScriptDeploymentRun do
  @moduledoc """
  Deployment run records for selected clients.
  """
  ...
  attributes do
    ...
    attribute :status, Nixstasis.Types.ScriptDeploymentStatus do
      allow_nil? false
      default :pending
      public? true
    end
