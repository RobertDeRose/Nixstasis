defmodule NixstasisWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NixstasisWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NixstasisWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def modal(assigns) do
    ...
    >
      ...
      />
      <div
        class="fixed inset-0 overflow-y-auto modal-dialog"
