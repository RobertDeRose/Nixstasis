...
config :nixstasis, NixstasisWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: NixstasisWeb.ErrorHTML, json: NixstasisWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Nixstasis.PubSub,
  live_view: [signing_salt: "a8kB/r3M"]
...
config :nixstasis, Nixstasis.Mailer, adapter: Swoosh.Adapters.Local
...
config :logger, :default_formatter,
  ...
  metadata: [:device_id, :payload, :request_id]
