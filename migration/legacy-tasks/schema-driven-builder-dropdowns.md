...
**Input**: Feature design and current server module docs.
...
- [x] T036 Update schema-driven builder documentation in `packages/server/README.md` and module docs.
- [ ] T037 Run verification flow and record implementation notes in feature docs.
- [ ] T038 P Measure alert builder task-completion time against the 90-second target.
- [ ] T039 P Measure report builder task-completion time against the 90-second target.
- [x] T040 Define baseline metric queries for invalid-save rate, first-attempt completion, and support-ticket volume.
...
- [x] T042 Add post-release validation checklist for SC-003/SC-004/SC-005.
