# Tasks: Device Detail Page

**Input**: Feature design and current device UI docs.

> Terminology note: task text uses "modal" for the route-backed LiveView detail
> presentation opened from `/devices/:id`. It does not refer to the retired
> `/api/v1/devices/:device_id/modal` REST endpoints.

## Phase 1: Setup (Shared Infrastructure)

**Purpose**: Prepare baseline docs and fixtures for implementation and validation.

- [X] T001 Align feature documentation cross-links in feature docs.
...
- [X] T038 US3 Add support-ticket reduction measurement procedure for SC-004.
...
- [X] T028 P Update feature verification notes with final behavior checks.
- [X] T029 Execute full validation flow and capture completion notes.
