...
_Goal: Initialize dashboard structure and shared components._
...
_Goal: Implement backend aggregation logic and Context API._
...
_Goal: Display real-time fleet health overview._
...
_Goal: Enable navigation from dashboard to management views._
...
_Goal: Refine UX and ensure robust error handling._
...
- [x] T028 Add loading state while stats fetch in `lib/nixstasis_web/live/dashboard_live/index.html.heex`
- [x] T029 Verify manual dashboard validation steps.
