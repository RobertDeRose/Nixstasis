...
validates the operator `.env`, Caddy policy shape, and rendered production stack,
then runs Docker Compose build validation. It requires a working Docker daemon.
