...
require_text "$CLIENT_DOCKERFILE" 'useradd --system --create-home --home-dir /var/lib/nixstasis --shell /bin/bash nixstasis'
...
require_text "$CLIENT_POSTINSTALL" 'useradd --system --create-home --home-dir /var/lib/nixstasis --shell /bin/bash nixstasis'
require_text "$CLIENT_POSTINSTALL" 'usermod --home /var/lib/nixstasis --shell /bin/bash nixstasis'
